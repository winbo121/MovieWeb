...
public class EgovSampleController {
	...
	@RequestMapping(value = "/movieRanking.do", method = RequestMethod.GET)
	public String movieRanking( Model model) throws Exception {

		return "sample/movie_ranking";
	}
	
	@RequestMapping(value = "/movieSearch.do", method = RequestMethod.GET)
	public String movieSearch( Model model) throws Exception {

		return "sample/movie_search";
	}
	...
	@RequestMapping(value = "/newMovie.do", method = RequestMethod.GET)
	public String newMovie( Model model) throws Exception {

		return "sample/new_movie";
	}
